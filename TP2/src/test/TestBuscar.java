...
public class TestBuscar {
    public static void main(String[] args) {
        ...
        System.out.println("Buscar Sofía: " + arbol.buscar(new Persona("Sofía", "32145678"), cmp));
        System.out.println("Buscar Diego: " + arbol.buscar(new Persona("Diego", "31247896"), cmp));
        System.out.println("Buscar Pedro (no existe): " + arbol.buscar(new Persona("Pedro", "12345678"), cmp));
